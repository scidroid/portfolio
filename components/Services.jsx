...
const Services = () => {
  return (
    <section className="flex flex-col justify-center items-center m-4">
      <h2 className="mr-6 ml-6 mt-6 hero-gradient-heading text-2xl font-bold">
        SERVICES
      </h2>
      <p className="mr-8 ml-8 text-5xl font-bold text-center">
        Products that solves problems, one app at a time
      </p>
      <section className="m-4 flex flex-wrap flex-row items-center justify-around">
        <article className="m-6 max-w-sm">
          <Image src="/s1.svg" width={70} height={70} alt="Services image" />
          <h2 className="mt-4 mb-4 font-bold text-2xl">
        ...
        <article className="m-6 max-w-sm">
          ...
          <h2 className="mt-4 mb-4 font-bold text-2xl">What you can expect</h2>
          <p className="mb-4 text-lg text-gray-600">
