...
<SyntaxHighlighter language="console">
  {`C:\Users\SciDroid>python Python 3.10.1 (tags/v3.10.1:2cd268a, Dec 6 2021,
  19:10:37) [MSC v.1929 64 bit (AMD64)] on win32 Type "help", "copyright",
  "credits" or "license" for more information. >>>`}
</SyntaxHighlighter>

Here you only have to write this and something magical will happen.

<SyntaxHighlighter language="python">{`print("Hello World")`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="console">{`cd downloads`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`player_lifes = 5`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`name = "Jhon" print(name)`}</SyntaxHighlighter>

and if we run it it will result in the following.

<SyntaxHighlighter language="console">{`Jhon`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`name = input("What is your name?: ")`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`string = "This is a string."`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`integer = 5`}</SyntaxHighlighter>

### Floats

Floats are very similar to integers, the only difference is that they always have a decimal place.

<SyntaxHighlighter language="python">{`floating = 4.53`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`out_of_a_loop = True`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`lives = "5" int(lifes)`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`# We will ask for the year of birth and the year in which you want to calculate your age.
birth_year = int(input("What year were you born?: "))
year_to_calculated = int(input("In what year do you want to know your age?: "))
# Now we show the result
print(f"in {year_to_calculate} your age will be {year_to_calculate - birth_year}")`}</SyntaxHighlighter>
...
<SyntaxHighlighter language="python">{`# this code asks for the user's age and then displays it on the screen.
# We ask for the age and store it in a variable.
age = input("Enter your age: ")
# We pass on the screen the value of the variable age.
print(age)`}</SyntaxHighlighter>
