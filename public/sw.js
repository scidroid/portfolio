if (!self.define) {
  ...
  self.define = (i, a) => {
    ...
    let o = {};
    const r = e => n(e, c),
      f = { module: { uri: c }, exports: o, require: r };
    s[c] = Promise.all(i.map(e => f[e] || r(e))).then(e => (a(...e), o));
  };
}
define(['./workbox-1846d813'], function (e) {
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        {
          url: '/_next/static/Zq18Hzb6Lfd52ec0f3oa4/_buildManifest.js',
          revision: 'Zq18Hzb6Lfd52ec0f3oa4'
        },
        {
          url: '/_next/static/Zq18Hzb6Lfd52ec0f3oa4/_middlewareManifest.js',
          revision: 'Zq18Hzb6Lfd52ec0f3oa4'
        },
        {
          url: '/_next/static/Zq18Hzb6Lfd52ec0f3oa4/_ssgManifest.js',
          revision: 'Zq18Hzb6Lfd52ec0f3oa4'
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/_app-ad01023077d311a4.js',
          revision: 'Zq18Hzb6Lfd52ec0f3oa4'
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/contact-59edeee5c5b49834.js',
          revision: 'Zq18Hzb6Lfd52ec0f3oa4'
        },
        {
        ...
        { url: '/config.yml', revision: 'aa6b6150f755f1d6881bcf35e76244d6' },
        ...
        { url: '/rss.xml', revision: '213de910896c3332d2f0e82ba7ad100e' },
        ...
        { url: '/sitemap.xml', revision: '41b4cda4a032a8af827df08798680a43' },
